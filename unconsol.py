# -*- coding: utf-8 -*-
"""
Created on Wed Dec 12 06:00:54 2018

Python code by: Fanka, W. Roye T.

Ref: from MATLAB code by Jack Dvorkin (with I/O modifications by T. Mukerji);
...
def Unconsol(*args):
    ...
    # =============================================================================
    Function computes the modified Hashin-Shtrikman lower bound with 
    Hertz-Mindlin end point, for Marine Sediment Skeleton and returns a list of 
    arrays: 
        outputuncon=[porosity, M-modulus, shear-modulus]; 
        
    Used for modeling unconsolidated sediments.
    ...
    Returns a list of arrays: result=[porosity M-modulus shear-modulus];
